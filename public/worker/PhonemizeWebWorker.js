...
var wt = ut((je, B) => {
  var ke = {},
    ...
    Te = (() => {
      ...
      return (
        typeof __filename < "u" && (x = x || __filename),
        function (y = {}) {
          var T,
            l = y,
            q,
            ...
            re = typeof WorkerGlobalScope < "u",
            se =
              typeof process == "object" &&
              typeof process.versions == "object" &&
              typeof process.versions.node == "string" &&
              process.type != "renderer";
          ((l.expectedDataFileDownloads ??= 0),
            l.expectedDataFileDownloads++,
            (() => {
              var e = typeof ENVIRONMENT_IS_PTHREAD < "u" && ENVIRONMENT_IS_PTHREAD,
                a = typeof ENVIRONMENT_IS_WASM_WORKER < "u" && ENVIRONMENT_IS_WASM_WORKER;
              if (e || a) return;
              var t =
                typeof process == "object" &&
                typeof process.versions == "object" &&
              ...
              function r(s) {
                ...
                var i = "piper_phonemize.data",
                  o = "piper_phonemize.data",
                  d = l.locateFile ? l.locateFile(o, "") : o,
                  m = s.remote_package_size;
                function g(f, S, N, A) {
                  if (t) {
                  ...
                  ((l.dataFileDownloads ??= {}),
                    fetch(f)
                      .catch((w) => Promise.reject(new Error(`Network Error: ${f}`, { cause: w })))
                      .then((w) => {
                        if (!w.ok) return Promise.reject(new Error(`${w.status}: ${w.url}`));
                        if (!w.body && w.arrayBuffer) return w.arrayBuffer().then(N);
                        const M = w.body.getReader(),
                          R = () =>
                            M.read()
                              .then(gt)
                              .catch((ve) =>
                                Promise.reject(
                                  new Error(`Unexpected error while handling : ${w.url} ${ve}`, {
                                    cause: ve,
                                  }),
                                ),
                              ),
                          F = [],
                          C = w.headers,
                          D = Number(C.get("Content-Length") ?? S);
                        let ra = 0;
                        const gt = ({ done: ve, value: sa }) => {
                          if (ve) {
                            const te = new Uint8Array(
                              F.map((U) => U.length).reduce((U, vt) => U + vt, 0),
                            );
                            let ne = 0;
                            for (const U of F) (te.set(U, ne), (ne += U.length));
                            N(te.buffer);
                          } else {
                            (F.push(sa),
                              (ra += sa.length),
                              (l.dataFileDownloads[f] = { loaded: ra, total: D }));
                            let te = 0,
                              ne = 0;
                ...
                var _ = null,
                  u = l.getPreloadedPackage ? l.getPreloadedPackage(d, m) : null;
                u ||
                  g(
                    d,
                    m,
                ...
                function p(f) {
                  ...
                  (f.FS_createPath("/", "espeak-ng-data", !0, !0),
                    f.FS_createPath("/espeak-ng-data", "lang", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "aav", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "art", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "azc", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "bat", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "bnt", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "ccs", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "cel", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "cus", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "dra", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "esx", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "gmq", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "gmw", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "grk", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "inc", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "ine", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "ira", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "iro", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "itc", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "jpx", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "map", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "miz", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "myn", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "poz", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "roa", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "sai", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "sem", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "sit", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "tai", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "trk", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "urj", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "zle", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "zls", !0, !0),
                    f.FS_createPath("/espeak-ng-data/lang", "zlw", !0, !0),
                    f.FS_createPath("/espeak-ng-data", "mbrola_ph", !0, !0),
                    f.FS_createPath("/espeak-ng-data", "voices", !0, !0),
                    f.FS_createPath("/espeak-ng-data/voices", "!v", !0, !0),
                    f.FS_createPath("/espeak-ng-data/voices", "mb", !0, !0));
                  function N(R, F, C) {
                  ...
                  N.prototype = {
                    ...
                    finish: function (R) {
                      var F = this;
                      (f.FS_createDataFile(this.name, null, R, !0, !0, !0),
                        f.removeRunDependency(`fp ${F.name}`),
                  ...
                  function M(R) {
                    (S(R, "Loading data file failed."),
                      S(
                        R.constructor.name === ArrayBuffer.name,
                  ...
                  (f.addRunDependency("datafile_piper_phonemize.data"),
                    (f.preloadResults ??= {}),
                    (f.preloadResults[i] = { fromCache: !1 }),
                    u ? (M(u), (u = null)) : (_ = M));
                }
          ...
          if (se) {
            ...
            ((L = __dirname + "/"),
              ...
              !l.thisProgram &&
                ...
                (ie = process.argv[1].replace(/\\/g, "/")),
              (we = process.argv.slice(2)),
              (be = (e, a) => {
          ...
          var Ee = l.print || console.log.bind(console),
            I = l.printErr || console.error.bind(console);
          (Object.assign(l, Ce),
            (Ce = null),
            l.arguments && (we = l.arguments),
            l.thisProgram && (ie = l.thisProgram));
          var de = l.wasmBinary,
            xe,
            Oe = !1,
            Se,
          ...
          function oa() {
            var e = xe.buffer;
            ((l.HEAP8 = j = new Int8Array(e)),
              (l.HEAP16 = Q = new Int16Array(e)),
              (l.HEAPU8 = G = new Uint8Array(e)),
              (l.HEAPU16 = new Uint16Array(e)),
              (l.HEAP32 = k = new Int32Array(e)),
              (l.HEAPU32 = P = new Uint32Array(e)),
              (l.HEAPF32 = new Float32Array(e)),
              (l.HEAPF64 = new Float64Array(e)));
          }
          var Le = [],
            Ue = [],
            da = [],
          ...
          var ua = "data:application/octet-stream;base64,",
            Ie = (e) => e.startsWith(ua),
            fe = (e) => e.startsWith("file://");
          function ka() {
          ...
          var Pe;
          function ha(e) {
            if (e == Pe && de) return new Uint8Array(de);
            if (Z) return Z(e);
          ...
          async function wa(e, a) {
            try {
              var t = await _a(e),
                r = await WebAssembly.instantiate(t, a);
              return r;
            } catch (s) {
          ...
          async function ba(e, a, t) {
            if (
              ...
              try {
                var r = fetch(a, { credentials: "same-origin" }),
                  s = await WebAssembly.instantiateStreaming(r, t);
                return s;
              } catch (i) {
          ...
          l.noExitRuntime;
          var He = typeof TextDecoder < "u" ? new TextDecoder() : void 0,
            V = (e, a = 0, t = NaN) => {
              for (var r = a + t, s = a; e[s] && !(s >= r); ) ++s;
              if (s - a > 16 && e.buffer && He) return He.decode(e.subarray(a, s));
              for (var i = ""; a < s; ) {
                var o = e[a++];
                if (!(o & 128)) {
            ...
            Sa = (e, a, t, r) =>
              W(
                `Assertion failed: ${ce(e)}, at: ` +
                  [a ? ce(a) : "unknown filename", t, r ? ce(r) : "unknown function"],
              );
          class Fa {
            constructor(a) {
          ...
          var We = 0,
            ...
            Da = () => {
              ...
              if (se)
                try {
                  var e = ke || Me,
                    a = e.randomFillSync;
                  if (a) return (r) => e.randomFillSync(r);
                  var t = e.randomBytes;
            ...
            K = {
              ...
              relative: (e, a) => {
                ...
                for (var m = [], d = o; d < r.length; d++) m.push("..");
...
`));
            ...
            $ = {
              ...
              shutdown() {},
              register(e, a) {
                (($.ttys[e] = { input: [], output: [], ops: a }),
                  n.registerDevice(e, $.stream_ops));
              },
              stream_ops: {
                open(e) {
                  var a = $.ttys[e.node.rdev];
                  if (!a) throw new n.ErrnoError(43);
                ...
                read(e, a, t, r, s) {
                  ...
                  for (var i = 0, o = 0; o < r; o++) {
                    ...
                    if (d === void 0 && i === 0) throw new n.ErrnoError(6);
                    if (d == null) break;
                    (i++, (a[t + o] = d));
                  }
                ...
                write(e, a, t, r, s) {
                  ...
                  try {
                    for (var i = 0; i < r; i++) e.tty.ops.put_char(e.tty, a[t + i]);
                  } catch {
                    throw new n.ErrnoError(29);
                  }
            ...
            v = {
              ...
              createNode(e, a, t, r) {
                ...
                v.ops_table ||= {
                  dir: {
                    ...
                    stream: { llseek: v.stream_ops.llseek },
                  },
                  file: {
                    node: { getattr: v.node_ops.getattr, setattr: v.node_ops.setattr },
                    stream: {
                      llseek: v.stream_ops.llseek,
                      read: v.stream_ops.read,
                      write: v.stream_ops.write,
                      allocate: v.stream_ops.allocate,
                ...
                return (
                  n.isDir(s.mode)
                    ? ((s.node_ops = v.ops_table.dir.node),
                      (s.stream_ops = v.ops_table.dir.stream),
                      (s.contents = {}))
                    : n.isFile(s.mode)
                      ? ((s.node_ops = v.ops_table.file.node),
                        (s.stream_ops = v.ops_table.file.stream),
                        (s.usedBytes = 0),
                        (s.contents = null))
                      : n.isLink(s.mode)
                        ? ((s.node_ops = v.ops_table.link.node),
                          (s.stream_ops = v.ops_table.link.stream))
                        : n.isChrdev(s.mode) &&
                          ((s.node_ops = v.ops_table.chrdev.node),
                          (s.stream_ops = v.ops_table.chrdev.stream)),
                  (s.atime = s.mtime = s.ctime = Date.now()),
                  e && ((e.contents[a] = s), (e.atime = e.mtime = e.ctime = s.atime)),
                  s
                );
              },
              ...
              expandFileStorage(e, a) {
                ...
                if (!(t >= a)) {
                  var r = 1024 * 1024;
                  ((a = Math.max(a, (t * (t < r ? 2 : 1.125)) >>> 0)),
                    t != 0 && (a = Math.max(a, 256)));
                  var s = e.contents;
                  ((e.contents = new Uint8Array(a)),
                    e.usedBytes > 0 && e.contents.set(s.subarray(0, e.usedBytes), 0));
                }
              },
              ...
              node_ops: {
                getattr(e) {
                  var a = {};
                  return (
                    (a.dev = n.isChrdev(e.mode) ? e.id : 1),
                    (a.ino = e.id),
                    (a.mode = e.mode),
                    (a.nlink = 1),
                    (a.uid = 0),
                    ...
                    n.isDir(e.mode)
                      ...
                      : n.isFile(e.mode)
                        ...
                        : n.isLink(e.mode)
                          ...
                          : (a.size = 0),
                    (a.atime = new Date(e.atime)),
                    (a.mtime = new Date(e.mtime)),
                    (a.ctime = new Date(e.ctime)),
                    (a.blksize = 4096),
                ...
                setattr(e, a) {
                  for (const t of ["mode", "atime", "mtime", "ctime"]) a[t] && (e[t] = a[t]);
                ...
                rename(e, a, t) {
                  ...
                  if (r) {
                    if (n.isDir(e.mode)) for (var s in r.contents) throw new n.ErrnoError(55);
                    n.hashRemoveNode(r);
                  }
                  (delete e.parent.contents[e.name],
                    (a.contents[t] = e),
                    (e.name = t),
                    (a.ctime = a.mtime = e.parent.ctime = e.parent.mtime = Date.now()));
                },
                unlink(e, a) {
                ...
                rmdir(e, a) {
                  ...
                  for (var r in t.contents) throw new n.ErrnoError(55);
                  (delete e.contents[a], (e.ctime = e.mtime = Date.now()));
                },
                readdir(e) {
              ...
              stream_ops: {
                read(e, a, t, r, s) {
                  ...
                  if (o > 8 && i.subarray) a.set(i.subarray(s, s + o), t);
                  else for (var d = 0; d < o; d++) a[t + d] = i[s + d];
                  return o;
                },
                write(e, a, t, r, s, i) {
                  if (!r) return 0;
                ...
                llseek(e, a, t) {
                  ...
                  if (
                    (t === 1
                      ? (r += e.position)
                      : t === 2 && n.isFile(e.node.mode) && (r += e.node.usedBytes),
                    r < 0)
                  )
                ...
                allocate(e, a, t) {
                  (v.expandFileStorage(e.node, a + t),
                ...
                mmap(e, a, t, r, s) {
                  ...
                  var i,
                    o,
                    d = e.node.contents;
                  if (!(s & 2) && d && d.buffer === j.buffer) ((o = !1), (i = d.byteOffset));
                  else {
                    if (((o = !0), (i = Ve()), !i)) throw new n.ErrnoError(48);
                    d &&
                      ((t > 0 || t + a < d.length) &&
                        (d.subarray
                          ? (d = d.subarray(t, t + a))
                          : (d = Array.prototype.slice.call(d, t, t + a))),
                      j.set(d, i));
                  }
            ...
            n = {
                ...
                e: for (var t = 0; t < 40; t++) {
                  for (
                    ...
                    try {
                      ...
                      if (g?.errno === 44 && d && a.noent_okay) return { path: i };
                      throw g;
                    }
                    if (
                      (n.isMountpoint(s) && (!d || a.follow_mount) && (s = s.mounted.root),
                      n.isLink(s.mode) && (!d || a.follow))
                    ) {
                      if (!s.node_ops.readlink) throw new n.ErrnoError(52);
                      var m = s.node_ops.readlink(s);
                      (b.isAbs(m) || (m = b.dirname(i) + "/" + m),
                        (e = m + "/" + r.slice(o + 1).join("/")));
                      continue e;
                    }
                  }
              ...
              hashName(e, a) {
                for (var t = 0, r = 0; r < a.length; r++) t = ((t << 5) - t + a.charCodeAt(r)) | 0;
              ...
              hashRemoveNode(e) {
                var a = n.hashName(e.parent.id, e.name);
                if (n.nameTable[a] === e) n.nameTable[a] = e.name_next;
                else
              ...
              lookupNode(e, a) {
                ...
                for (var r = n.hashName(e.id, a), s = n.nameTable[r]; s; s = s.name_next) {
                  var i = s.name;
                  if (s.parent.id === e.id && i === a) return s;
                }
                return n.lookup(e, a);
              },
              createNode(e, a, t, r) {
              ...
              mayOpen(e, a) {
                return e
                  ? n.isLink(e.mode)
                    ? 32
                    : n.isDir(e.mode) && (n.flagsToPermissionString(a) !== "r" || a & 512)
                      ? 31
                      : n.nodePermissions(e, n.flagsToPermissionString(a))
                  : 44;
              },
              MAX_OPEN_FDS: 4096,
              nextfd() {
              ...
              syncfs(e, a) {
                ...
                function i(o) {
                  if (o) return i.errored ? void 0 : ((i.errored = !0), s(o));
                  ++r >= t.length && s(null);
                }
                t.forEach((o) => {
                  if (!o.type.syncfs) return i(null);
                  o.type.syncfs(o, e, i);
                });
              },
              mount(e, a, t) {
                ...
                if (!r && !s) {
                  ...
                  if (((t = o.path), (i = o.node), n.isMountpoint(i))) throw new n.ErrnoError(10);
                  if (!n.isDir(i.mode)) throw new n.ErrnoError(54);
                }
                var d = { type: e, opts: a, mountpoint: t, mounts: [] },
                  m = e.mount(d);
                return (
                  (m.mount = d),
                  (d.root = m),
                  r ? (n.root = m) : i && ((i.mounted = d), i.mount && i.mount.mounts.push(d)),
                  m
                );
              },
              unmount(e) {
                var a = n.lookupPath(e, { follow_mount: !1 });
                if (!n.isMountpoint(a.node)) throw new n.ErrnoError(28);
                var t = a.node,
                  r = t.mounted,
                  s = n.getMounts(r);
              ...
              statfs(e) {
                ...
                return (
                  t?.node_ops.statfs && Object.assign(a, t.node_ops.statfs(t.mount.opts.root)),
                  a
                );
              },
              create(e, a = 438) {
              ...
              symlink(e, a) {
                ...
                var t = n.lookupPath(a, { parent: !0 }),
                  r = t.node;
                if (!r) throw new n.ErrnoError(44);
                var s = b.basename(a),
                  i = n.mayCreate(r, s);
                if (i) throw new n.ErrnoError(i);
                if (!r.node_ops.symlink) throw new n.ErrnoError(63);
              ...
              rename(e, a) {
                var t = b.dirname(e),
                  ...
                  m;
                if (
                  ((o = n.lookupPath(e, { parent: !0 })),
                  (d = o.node),
                  (o = n.lookupPath(a, { parent: !0 })),
                  (m = o.node),
                  !d || !m)
                )
                  throw new n.ErrnoError(44);
                if (d.mount !== m.mount) throw new n.ErrnoError(75);
                var g = n.lookupNode(d, s),
                  h = K.relative(e, r);
                if (h.charAt(0) !== ".") throw new n.ErrnoError(28);
                if (((h = K.relative(a, t)), h.charAt(0) !== ".")) throw new n.ErrnoError(55);
                var _;
                try {
                  _ = n.lookupNode(m, i);
                } catch {}
                if (g !== _) {
                  var u = n.isDir(g.mode),
                    p = n.mayDelete(d, s, u);
                  if (p) throw new n.ErrnoError(p);
                  if (((p = _ ? n.mayDelete(m, i, u) : n.mayCreate(m, i)), p))
                    throw new n.ErrnoError(p);
                  if (!d.node_ops.rename) throw new n.ErrnoError(63);
                  if (n.isMountpoint(g) || (_ && n.isMountpoint(_))) throw new n.ErrnoError(10);
                  if (m !== d && ((p = n.nodePermissions(d, "w")), p)) throw new n.ErrnoError(p);
                  n.hashRemoveNode(g);
                  try {
              ...
              stat(e, a) {
                var t = n.lookupPath(e, { follow: !a }),
                  r = t.node;
                if (!r) throw new n.ErrnoError(44);
                if (!r.node_ops.getattr) throw new n.ErrnoError(63);
              ...
              chown(e, a, t, r) {
                ...
                if (!s.node_ops.setattr) throw new n.ErrnoError(63);
              ...
              truncate(e, a) {
                if (a < 0) throw new n.ErrnoError(28);
                var t;
                if (typeof e == "string") {
              ...
              ftruncate(e, a) {
                var t = n.getStreamChecked(e);
                if ((t.flags & 2097155) === 0) throw new n.ErrnoError(28);
                n.truncate(t.node, a);
              },
              utime(e, a, t) {
                var r = n.lookupPath(e, { follow: !0 }),
              ...
              open(e, a, t = 438) {
                ...
                ((a = typeof a == "string" ? Ma(a) : a),
                  a & 64 ? (t = (t & 4095) | 32768) : (t = 0));
                var r;
                ...
                if (a & 64)
                  if (r) {
                    if (a & 128) throw new n.ErrnoError(20);
                  } else ((r = n.mknod(e, t, 0)), (i = !0));
                if (!r) throw new n.ErrnoError(44);
                ...
                return (
                  ...
                  l.logReadFiles && !(a & 1) && (e in n.readFiles || (n.readFiles[e] = 1)),
                  d
                );
              },
              close(e) {
              ...
              read(e, a, t, r, s) {
                if (r < 0 || s < 0) throw new n.ErrnoError(28);
                if (n.isClosed(e)) throw new n.ErrnoError(8);
              ...
              write(e, a, t, r, s, i) {
                if (r < 0 || s < 0) throw new n.ErrnoError(28);
                if (n.isClosed(e)) throw new n.ErrnoError(8);
                if ((e.flags & 2097155) === 0) throw new n.ErrnoError(8);
                if (n.isDir(e.node.mode)) throw new n.ErrnoError(31);
              ...
              allocate(e, a, t) {
                if (n.isClosed(e)) throw new n.ErrnoError(8);
                if (a < 0 || t <= 0) throw new n.ErrnoError(28);
                if ((e.flags & 2097155) === 0) throw new n.ErrnoError(8);
              ...
              readFile(e, a = {}) {
                ...
                return (
                  n.read(r, o, 0, i, 0),
                  a.encoding === "utf8" ? (t = V(o)) : a.encoding === "binary" && (t = o),
                  n.close(r),
                  t
                );
              },
              writeFile(e, a, t = {}) {
                ...
                if (typeof a == "string") {
                  var s = new Uint8Array(Ae(a) + 1),
                    i = Re(a, s, 0, s.length);
                  n.write(r, s, 0, i, void 0, t.canOwn);
                } else if (ArrayBuffer.isView(a)) n.write(r, a, 0, a.byteLength, void 0, t.canOwn);
              ...
              chdir(e) {
                var a = n.lookupPath(e, { follow: !0 });
                if (a.node === null) throw new n.ErrnoError(44);
                if (!n.isDir(a.node.mode)) throw new n.ErrnoError(54);
              ...
              createDefaultDevices() {
                (n.mkdir("/dev"),
                  ...
                  $.register(n.makedev(5, 0), $.default_tty_ops),
                  $.register(n.makedev(6, 0), $.default_tty1_ops),
                  n.mkdev("/dev/tty", n.makedev(5, 0)),
                  n.mkdev("/dev/tty1", n.makedev(6, 0)));
                var e = new Uint8Array(1024),
                  a = 0,
                  t = () => (a === 0 && (a = $e(e).byteLength), e[--a]);
                  ...
                  n.mount(
                    {
                      mount() {
                        ...
                        return (
                          (a.stream_ops = { llseek: v.stream_ops.llseek }),
                          (a.node_ops = {
                            lookup(t, r) {
                              var s = +r,
                                i = n.getStreamChecked(s),
                                o = {
                                  parent: null,
                            ...
                            readdir() {
                              return Array.from(n.streams.entries())
                                .filter(([t, r]) => r)
                                .map(([t, r]) => t.toString());
                            },
                          }),
              ...
              createStandardStreams(e, a, t) {
                (e ? n.createDevice("/dev", "stdin", e) : n.symlink("/dev/tty", "/dev/stdin"),
                  a
                    ? n.createDevice("/dev", "stdout", null, a)
              ...
              analyzePath(e, a) {
                ...
                try {
                  ...
                  ((r.parentExists = !0),
                    (r.parentPath = t.path),
                    (r.parentObject = t.node),
                    (r.name = b.basename(e)),
                    (t = n.lookupPath(e, { follow: !a })),
                    (r.exists = !0),
                    (r.path = t.path),
                    (r.object = t.node),
                    (r.name = t.node.name),
              ...
              createFile(e, a, t, r, s) {
                var i = b.join2(typeof e == "string" ? e : n.getPath(e), a),
                  o = ze(r, s);
                return n.create(i, o);
              },
              createDataFile(e, a, t, r, s, i) {
                ...
                if (t) {
                  if (typeof t == "string") {
                    for (var g = new Array(t.length), h = 0, _ = t.length; h < _; ++h)
                      g[h] = t.charCodeAt(h);
                    t = g;
                  }
                  n.chmod(m, d | 146);
              ...
              createDevice(e, a, t, r) {
                var s = b.join2(typeof e == "string" ? e : n.getPath(e), a),
                  i = ze(!!t, !!r);
                  ...
                  n.registerDevice(o, {
                    ...
                    read(d, m, g, h, _) {
                      for (var u = 0, p = 0; p < h; p++) {
                        ...
                        if (f === void 0 && u === 0) throw new n.ErrnoError(6);
                        if (f == null) break;
                        (u++, (m[g + p] = f));
                      }
              ...
              createLazyFile(e, a, t, r, s) {
                class i {
                  ...
                  get(p) {
                    if (!(p > this.length - 1 || p < 0)) {
                      var f = p % this.chunkSize,
                        S = (p / this.chunkSize) | 0;
                  ...
                  cacheLength() {
                    ...
                    var f = Number(p.getResponseHeader("Content-length")),
                      S,
                      N = (S = p.getResponseHeader("Accept-Ranges")) && S === "bytes",
                      A = (S = p.getResponseHeader("Content-Encoding")) && S === "gzip",
                      w = 1024 * 1024;
                    N || (w = f);
                    var M = (F, C) => {
                        if (F > C)
                          throw new Error(
                            "invalid range (" + F + ", " + C + ") or no bytes requested!",
                          );
                        if (C > f - 1)
                        ...
                        if (
                          (D.open("GET", t, !1),
                          f !== w && D.setRequestHeader("Range", "bytes=" + F + "-" + C),
                    ...
                    (R.setDataGetter((F) => {
                      ...
                      if (
                        ((D = Math.min(D, f - 1)),
                        typeof R.chunks[F] > "u" && (R.chunks[F] = M(C, D)),
                        typeof R.chunks[F] > "u")
                      )
                ...
                if (typeof XMLHttpRequest < "u") {
                  ...
                  var o = new i(),
                    d = { isDevice: !1, contents: o };
                } else var d = { isDevice: !1, url: t };
                var m = n.createFile(e, a, d, r, s);
                (d.contents
                  ? (m.contents = d.contents)
                  : d.url && ((m.contents = null), (m.url = d.url)),
                ...
                function _(u, p, f, S, N) {
                  ...
                  if (A.slice) for (var M = 0; M < w; M++) p[f + M] = A[N + M];
                  else for (var M = 0; M < w; M++) p[f + M] = A.get(N + M);
                  return w;
                }
                return (
                  (g.read = (u, p, f, S, N) => (n.forceLoadFile(m), _(u, p, f, S, N))),
                  (g.mmap = (u, p, f, S, N) => {
                    n.forceLoadFile(m);
                    var A = Ve();
            ...
            z = {
              ...
              doMsync(e, a, t, r, s) {
                if (!n.isFile(a.node.mode)) throw new n.ErrnoError(43);
                if (r & 2) return 0;
                var i = G.slice(e, e + t);
                n.msync(a, i, s, t, r);
              },
            ...
            try {
              ...
              for (
                var s = 280,
                  ...
                  o = n.llseek(r, 0, 1),
                  d = Math.floor(o / s),
                  m = Math.min(r.getdents.length, d + Math.floor(t / s)),
                  g = d;
                g < m;
                g++
              ) {
                ...
                if (u === ".") ((h = r.node.id), (_ = 4));
                  ...
                  try {
                    ...
                    if (S?.errno === 28) continue;
                    throw S;
                  }
                  ((h = f.id),
                    (_ = n.isChrdev(f.mode) ? 2 : n.isDir(f.mode) ? 4 : n.isLink(f.mode) ? 10 : 8));
                }
                ((E = [
                  h >>> 0,
                  ((c = h),
              ...
              switch (a) {
                ...
                case 21505: {
                  ...
                  if (r.tty.ops.ioctl_tcgets) {
                    var s = r.tty.ops.ioctl_tcgets(r),
                      i = X();
                    ((k[i >> 2] = s.c_iflag || 0),
                      (k[(i + 4) >> 2] = s.c_oflag || 0),
                      (k[(i + 8) >> 2] = s.c_cflag || 0),
                      (k[(i + 12) >> 2] = s.c_lflag || 0));
                    for (var o = 0; o < 32; o++) j[i + o + 17] = s.c_cc[o] || 0;
                    return 0;
                  }
                  return 0;
                }
                ...
                case 21523: {
                  ...
                  if (r.tty.ops.ioctl_tiocgwinsz) {
                    var u = r.tty.ops.ioctl_tiocgwinsz(r.tty),
                      i = X();
          ...
          var Ba = () => W(""),
            ...
            Je = () => Date.now(),
            Wa = (e) => e >= 0 && e <= 3,
            $a = (e, a) => ((a + 2097152) >>> 0 < 4194305 - !!e ? (e >>> 0) + a * 4294967296 : NaN);
          function Ga(e, a, t, r) {
            if (!Wa(e)) return 28;
            var s;
            e === 0 ? (s = Je()) : (s = Ha());
          ...
          var Va = (e) => {
            ...
            ae = () => {
              if (!ae.strings) {
                ...
                for (var t in Ne) Ne[t] === void 0 ? delete a[t] : (a[t] = Ne[t]);
                var r = [];
                for (var t in a) r.push(`${t}=${a[t]}`);
                ae.strings = r;
              }
              return ae.strings;
            },
            Ja = (e, a) => {
              for (var t = 0; t < e.length; ++t) j[a++] = e.charCodeAt(t);
              j[a] = 0;
            },
            Ya = (e, a) => {
              var t = 0;
          ...
          function rt(e, a, t, r, s) {
            ...
            try {
              ...
              return (
                ...
                (k[s >> 2] = E[0]),
                (k[(s + 4) >> 2] = E[1]),
                o.getdents && i === 0 && r === 0 && (o.getdents = null),
                0
              );
            } catch (d) {
              if (typeof n > "u" || d.name !== "ErrnoError") throw d;
          ...
          var ot = (e) => {
              if (e instanceof qe || e == "unwind") return Se;
              be(1, e);
            },
            Ze = (e) => ea(e),
            dt = (e) => {
            ...
            mt = n.createLazyFile,
            ct = n.createDevice;
          ((n.createPreloadedFile = Ke),
            n.staticInit(),
            (l.FS_createPath = n.createPath),
            (l.FS_createDataFile = n.createDataFile),
            (l.FS_createPreloadedFile = n.createPreloadedFile),
            (l.FS_unlink = n.unlink),
            (l.FS_createLazyFile = n.createLazyFile),
            (l.FS_createDevice = n.createDevice),
            (v.doesNotExistError = new n.ErrnoError(44)),
            (v.doesNotExistError.stack = "<generic error, no stack>"));
          var pt = {
              a: Sa,
              b: Pa,
              e: Ta,
            ...
            Y;
          Ea();
          var Qe = (l._main = (e, a) => (Qe = l._main = Y.y)(e, a)),
            ea = (e) => (ea = Y.A)(e);
          ((l.addRunDependency = Fe),
            (l.removeRunDependency = le),
            (l.callMain = aa),
            (l.FS_createPreloadedFile = Ke),
            (l.FS_unlink = ft),
            (l.FS_createPath = lt),
            (l.FS_createDevice = ct),
            (l.FS = n),
            (l.FS_createDataFile = Xe),
            (l.FS_createLazyFile = mt));
          var ge;
          ee = function e() {
            (ge || ta(), ge || (ee = e));
          };
          ...
          function ta(e = we) {
            if (H > 0 || (la(), H > 0)) return;
            function a() {
              ge ||
                ((ge = !0),
                (l.calledRun = !0),
                !Oe && (fa(), ma(), q(l), l.onRuntimeInitialized?.(), na && aa(e), ca()));
            }
            l.setStatus
              ? (l.setStatus("Running..."),
                setTimeout(() => {
  ...
  typeof je == "object" && typeof B == "object"
    ? ((B.exports = Te), (B.exports.default = Te))
    : typeof define == "function" && define.amd && define([], () => Te);
  ...
  class ht {
    ...
    async fetch(y) {
      return this.#e[y]
        ? Promise.resolve(this.#e[y])
        : fetch(y)
            .then(async (T) => {
              if (!T.ok) throw new Error("Could not fetch: " + y);
  ...
  class _t {
    ...
    async loadModule(y = null, T = null) {
      return (
        (this.#t = y || this.#t || (await this.#e.fetch(this.#s + "piper_phonemize.wasm"))),
        (this.#n = T || this.#n || (await this.#e.fetch(this.#s + "piper_phonemize.data"))),
        this.#r ||
          (this.#r = await kt({
            print: (l) => {
            ...
            locateFile: (l, q) =>
              l.endsWith(".wasm") ? this.#t : l.endsWith(".data") ? this.#n : l,
          })),
