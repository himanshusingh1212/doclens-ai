...
> **Remediation**: The code was updated to use `arrayBuffer.slice(0)` to create a clone _before_ passing it to the PDF renderer, ensuring a valid buffer remains for database persistence.
